...
namespace Fishing_Helper.Model.Db_configurations
{
    public class FishDataContext : DbContext
    {
       ...
       public DbSet<FishType> FishTypes { get; set; }
        ...
        {
            optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=FishDB;Encrypt=False;Trusted_Connection=True;");
        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            new PriceConfigurator().Configure(modelBuilder.Entity<Price>());
            new LocationConfigurator().Configure(modelBuilder.Entity<Location>());
            new FishTypeConfigurator().Configure(modelBuilder.Entity<FishType>());
            new FishConfigurator().Configure(modelBuilder.Entity<Fish>());
        }
